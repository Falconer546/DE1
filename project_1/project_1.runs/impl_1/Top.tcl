namespace eval ::optrace {
  variable script "C:/vivado projekty/project_1/project_1.runs/impl_1/Top.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/honzi/AppData/Roaming/Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:nexys-a7-50t:part0:1.2 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {C:/vivado projekty/project_1/project_1.cache/wt} [current_project]
  set_property parent.project_path {C:/vivado projekty/project_1/project_1.xpr} [current_project]
  set_property ip_output_repo {{C:/vivado projekty/project_1/project_1.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{C:/vivado projekty/project_1/project_1.runs/synth_1/Top.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{C:/vivado projekty/project_1/project_1.srcs/constrs_1/new/nexys-a7-50t.xdc}}
