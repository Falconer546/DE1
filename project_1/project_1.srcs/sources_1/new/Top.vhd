...
entity Top is
    port (
        ...
        BTNR      : in  std_logic;                 -- Mezičas (Lap)
        SW        : in  std_logic_vector(10 downto 0);  -- SW0 = mode, SW1-SW10 = časovač
...
begin
    ...
    -- Clock enable pro časování (100ms pro desetiny/setiny sekundy)
...
clkLogic : entity work.clockLogic
    port map (
        ...
        rst      => BTNC,
        start    => BTNU,
        clk_en   => clk_selected,  -- Dynamický výběr
        mode     => SW(0),
