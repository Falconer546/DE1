...
architecture Behavioral of segmentLogic is
    signal digit_index   : unsigned(2 downto 0) := (others => '0');    -- logika pro ?íslice
    signal current_digit : std_logic_vector(3 downto 0);               -- Logika zobrazení ?íslic
begin
